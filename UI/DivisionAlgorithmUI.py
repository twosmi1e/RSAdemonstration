...
class Ui_Form_Divisonalgorithm(object):
    def setupUi(self, Form_Divisonalgorithm):
        ...
        Form_Divisonalgorithm.resize(665, 457)
        self.label = QtWidgets.QLabel(Form_Divisonalgorithm)
        self.label.setGeometry(QtCore.QRect(30, 8, 261, 51))
        font = QtGui.QFont()
        ...
        self.tableWidget.setGeometry(QtCore.QRect(10, 180, 641, 261))
        self.tableWidget.setObjectName("tableWidget")
        self.tableWidget.setColumnCount(0)
        self.tableWidget.setRowCount(0)
        self.pushButton = QtWidgets.QPushButton(Form_Divisonalgorithm)
        self.pushButton.setGeometry(QtCore.QRect(340, 22, 81, 31))
